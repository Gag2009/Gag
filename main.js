...
function reloadall() {
    document.getElementById("click").innerHTML =
        "Coins/click: " + addcomma(moneyup) + " | Coins/sec: " + addcomma(msec);
    document.getElementById("total").innerHTML = "Coins: " + addcomma(money);
...
function upgrade(name) {
    ...
    document.getElementById("click").innerHTML =
        "Coins/Клик: " + addcomma(moneyup) + " | Coins/сек: " + addcomma(msec);
    document.getElementById("total").innerHTML = "Coins: " + addcomma(money);
}